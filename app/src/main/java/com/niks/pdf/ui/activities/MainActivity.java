...
import com.niks.pdf.ui.fragment.HomeFragment;
import com.niks.pdf.ui.fragment.PDFViewerFragment;
import com.niks.pdf.ui.fragment.ReuseFragment;
import com.niks.pdf.ui.fragment.VolumeFragment;
    ...
    private void navigate(final int itemId) {
        ...
        switch (itemId) {
            ...
            case R.id.nav_2:
                mPrevSelectedId = itemId;
                setTitle(R.string.nav_reward);
                navFragment = new PDFViewerFragment();
                break;

            case R.id.nav_3:
                mPrevSelectedId = itemId;
                setTitle(R.string.nav_reward);
                navFragment = new ReuseFragment();
                break;
